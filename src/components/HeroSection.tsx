...
export default function HeroSection({ title, subtitle, author, description }: HeroSectionProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-love-pink via-love-purple to-love-blue overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-white/8 rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
